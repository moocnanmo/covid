                ...
                formatter(params) {
                  ...
                  params.forEach(function (item, index) {
                    ...
                    result +=
                      ...
                      '：' +
                      item.data +
                      (config.showUnit ? config.showUnit : '') +
                      '<br>'
                  })
                  return result
                },
            ...
            var option = {
              tooltip: {
                ...
                formatter(item) {
                  ...
                  return (
                    '<div style="pointer-events: all;color:#fff" class="tooltip" onclick="myClick(\'' +
                    item.name +
                    '\')"><div class="tooltip_left"><div>省份：' +
                    item.name +
                    '</div><div>' +
                    title +
                    '：' +
                    item.value +
                    '</div></div><div class="tooltip_right">详情></div></div>'
                  )
                },
              },
              visualMap: [
